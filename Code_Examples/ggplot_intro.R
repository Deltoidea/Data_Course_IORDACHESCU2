...
ggplot(df,aes(x=hp,y=wt,color=cyl))+geom_point()

ggplot(df,aes(x=disp,y=mpg,color=cyl))+geom_point()+geom_smooth(method = "lm")+labs(color="Cylinders")
